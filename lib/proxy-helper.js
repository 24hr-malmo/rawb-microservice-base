...
exports.init = (apiToken) => {
    ...
    async function handleProxyResponse(url, options){
        ...
        try {
            ...
            console.log('Got an error when parsing the JSON response from the request to "%s" with GET. The status code was %s and the result was:', permalink, fetchPromise.status, dataString); // eslint-disable-line
    ...
    return {
        ...
        externalGet: async function(url, extraHeaders = {}){
        ...
        externalPost: async function(url, data, extraHeaders = {}){
